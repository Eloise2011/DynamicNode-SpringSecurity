package com.example.security08loginapi.result;
 ...
 * @description     企业项目开发中的常用做法.采用R类封装后端返回的结果
 *                  （不管后端返回什么数据，都用R封装，这样可以使得后端返回的数据结构是统一的）
 * @date 2025-12-24 21:14
 */
...
public class R {
    ...
    public static R OK() {
        ...
        R result = R.builder().code(200).msg("成功").info(null).build();
