package com.example.security06loginrolepermission.filter;
 ...
 */
@Component
public class CaptchaFilter extends OncePerRequestFilter { //implements Filter， 比起实现原生Filter,继承spring的
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        String requestUri = request.getRequestURI(); //   /user/login 登陆请求
