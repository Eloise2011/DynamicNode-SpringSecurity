package com.example.security07loginresourcepermission.config;

import com.example.security07loginresourcepermission.filter.CaptchaFilter;
                ...
                .formLogin(new Customizer<FormLoginConfigurer<HttpSecurity>>() {
                    ...
                    public void customize(FormLoginConfigurer<HttpSecurity> formLogin) {
                        ...
                        formLogin.loginProcessingUrl("/user/login") //登录的账号密码往哪个地址提交，也就是页面里登陆表单的提交地址
                                ...
                                .successForwardUrl("/welcome"); // 自定义登陆成功时的跳转URL
                    }
                })
